/*  1600002148 İlker Kılınçarslan
	...
	Computer Graphics Project 2019 Fall-Term
*/
var VSHADER_SOURCE =
  ...
  '  int face = int(a_Face);\n' + // Convert to int
  '  vec3 color = (face == u_PickedFace) ? vec3(0.3) : a_Color.rgb;\n' +
...
var ANGLE_STEP = 20; // Rotation angle (degrees/second)
var aroundX = 1;
var aroundY = 1;
var aroundZ = 1;
...
function main() {
  ...
  viewProjMatrix.setPerspective(78, 1.0, 1.0, 100.0);
